...
const Hero = () => {
  return (
        <section className="w-full bg-[#0a2855] text-white py-12 md:py-16 px-32">
        <div className="">
          <div className="flex items-center justify-center gap-20">
            <div className="w-[60%] space-y-6">
              ...
              <p className="text-lg">
                360 degree Digital Marketing with Hexafin! We have team of experts who can grow your brand exponential
            ...
            <div className="bg-white w-[40%]  text-black p-6 rounded-md">
